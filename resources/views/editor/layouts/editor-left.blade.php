...
<div id="editor-sidebar">
    <div class="sidebar-buttons">
      ...
      <a href="#" id="add-quote">
          ...
          <p style="font-size: 11px; margin-top: 5px">add quote</p></i>
      </a>

      <!-- Add Annotations Button -->
      <a href="#" id="add-annotation">
          <i class="fa fa-sticky-note"><br>
          <p style="font-size: 11px; margin-top: 5px">add annotation</p></i>
      </a>

      <!-- Add List Button -->
      <a href="#" id="add-lists">
          <i class="fa fa-list-ul"><br>
          <p style="font-size: 11px; margin-top: 5px">add lists</p></i>
      </a>
